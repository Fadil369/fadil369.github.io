...
/** Ecosystem links — updated with correct Google Calendar and Notion URLs */
export const CALENDAR_URL = 'https://calendar.app.google/Ve9KSKmaVA6ehDP48';
export const CALENDAR_BUILD_URL = 'https://calendar.app.google/rAqiE6pNumtECdnd7';
...
/** Telegram bot for progress tracking */
...
/** Shopify/Daftra native forms — infrastructure requirements intake (Solutions Ready 24k) */
/** The secure form is delivered via the welcome email after pre-built payment. */
export const INFRA_FORM_URL = 'https://store.brainsait.de/pages/solution-ready-intake';
...
export const BUILD_INSTALLMENT_PLANS: BuildInstallmentPlan[] = [
  {
    ...
    cadence_en: 'One-time',
    desc_ar: 'ادفع المبلغ كاملاُ مرة واحدة وابدأ فورًا بكل الموارد.',
