...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'cta.login': 'Sign in for free access',
    'free.note': '🎓 Free for account holders — sign in to unlock',
    'free.holder': '🎓 You\'re signed in — this title is free for you',
    'checkout.note': 'Secure checkout completes on store.brainsait.de — payments, entitlement routing, and fulfillment all happen there',
  ...
  ar: {
    ...
    'cta.login': 'سجّل دخولك للوصول المجاني',
    'free.note': '🎓 مجاني لأصحاب الحسابات — سجّل الدخول للتفعيل',
    'free.holder': '🎓 تم تسجيل دخولك — هذا العنوان مجاني لك',
    'checkout.note': 'يُستكمل الدفع بأمان على store.brainsait.de — هناك تتم المعاملة وربط الاستحقاق والتسليم',
