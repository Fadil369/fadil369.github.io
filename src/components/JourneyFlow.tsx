  ...
  return (
    <section className="reveal" style={{ margin: '2.2rem 0' }}>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 12 }}>
        ...
        <a className="button secondary sm" href="https://daftra.brainsait.org/shop?tab=learn" target="_blank" rel="noopener noreferrer" style={{ background: 'linear-gradient(135deg, #f59e0b, #d97706)', color: '#000', border: 'none' }}>🇸🇦 {ar ? 'المتجر العربي' : 'Arabic Store'}</a>
