      ...
      {status === 'signed-out' && (
        <>
          <p className="muted" style={{ marginBottom: '1rem' }}>
            {ar
              ? 'سجّل الدخول بحساب Shopify الخاص بك لعرض طلباتك مباشرة من store.brainsait.org.'
              : 'Sign in with your Shopify account to see your orders directly from store.brainsait.org.'}
          </p>
